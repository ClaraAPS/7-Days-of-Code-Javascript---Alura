...
while (add != "não") {
    ...
    if (p1 != "fruta" && p1 != "verdura" && p1 != "carne" && p1 !="laticínio" && p1 != "doce") {
...
while (remove == "sim") {
    ...
    if (r1 != "fruta" && r1 != "verdura" && r1 != "carne" && r1 !="laticínio" && r1 != "doce") {
        window.alert("Essa categoria não foi pré definida");
        ...
        if (r1 === "fruta" && f === true) {
            ...
            window.alert(`O item ${r2} foi removido com sucesso!`)
           ...
           window.alert(`O item ${r2} foi removido com sucesso!`)
            ...
            window.alert("Essa comida não está na sua lista");
        }
